...
export const selectedWork: Project[] = [
  {
    ...
    num: "01",
    title: "HELIX",
    description: "Trading & execution system with sub-millisecond risk telemetry.",
  ...
  },
  {
    ...
    description: "High-concurrency campaign, voucher, and dynamic rule evaluation engine.",
  ...
  },
  {
    ...
    description: "Multi-tier merchant management, payment routing, and settlement ledger.",
  ...
  },
  {
    ...
    description: "Event-driven points accounting ledger, tier progression, and rewards engine.",
    stack: "Go · Redis · PostgreSQL · NATS",
    period: "2022–2023",
    link: "#",
    external: false,
  },
  {
    ...
    description: "Distributed checkout, real-time inventory reservation, and order orchestration.",
    stack: "Go · PHP · PostgreSQL · Redis",
    period: "2022–2023",
    link: "#",
    external: false,
  },
  {
    ...
    num: "06",
    title: "NEXUS",
    description: "AI video generation and automated media production platform.",
